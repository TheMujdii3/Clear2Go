                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists())
                        for(DataSnapshot planeSnapshot:snapshot.getChildren()) {
                            if(planeSnapshot.child("lat").getValue(Double.class)!=null && planeSnapshot.child("lng").getValue(Double.class)!=null && planeSnapshot.child("heading").getValue(Double.class)!=null)
                                planesMap.put(planeSnapshot.getKey(),
                                    new obj(

                                            new LatLng( planeSnapshot.child("lat").getValue(Double.class),
                                                     planeSnapshot.child("lng").getValue(Double.class)),planeSnapshot.child("heading").getValue(Double.class),
